    ...
    >
      ...
      <div>
        ...
        >
          ...
          <option value="50-100k" className="bg-obsidian">
            $50,000 - $100,000
          </option>
          <option value="100-250k" className="bg-obsidian">
            $100,000 - $250,000
          </option>
          <option value="250-500k" className="bg-obsidian">
            $250,000 - $500,000
          </option>
          <option value="500k+" className="bg-obsidian">
            $500,000+
          </option>
        </select>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          aria-describedby={
            errors.project && touched.project ? "project-error" : undefined
          }
        />
        <div className="flex justify-between items-center mt-2">
          ...
          <span
            className={`text-xs ${
              formData.project.length < 20 ? "text-white/40" : "text-cyber-lime"
            }`}
          >
        ...
        <div className="grid grid-cols-2 gap-3">
          {services.map((service) => (
            <button
              ...
              `}
              aria-pressed={
                formData.services.includes(service) ? "true" : "false"
              }
            >
              <span
                className={`
