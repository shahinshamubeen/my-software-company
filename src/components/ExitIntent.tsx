...
export default function ExitIntent({ delay = 5000 }: ExitIntentProps) {
  ...
  const STORAGE_KEY = "wydgt-exit-intent-shown";
  const STORAGE_SUBSCRIBED_KEY = "wydgt-newsletter-subscribed";
                  ...
                  <>
                    ...
                    <div className="text-center mb-6">
                      ...
                      <p className="text-white/60">
                        Get exclusive insights on tech trends, case studies, and
                        startup growth tips delivered to your inbox.
                      </p>
                    </div>
                    ...
                    <ul className="space-y-2 mb-6">
                      {[
                        ...
                        >
                          <svg
                            className="w-4 h-4 text-cyber-lime shrink-0"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                            <path
