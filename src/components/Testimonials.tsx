...
const testimonials: Testimonial[] = [
  ...
  {
    quote: "The team delivered a payment system that handles billions in monthly volume with 99.999% uptime. They're not just developers—they're strategic partners.",
  ...
  {
    quote: "We went from idea to HIPAA-compliant platform in 4 months. Apex Labs understood healthcare regulations and built security into every layer.",
  ...
  {
    quote: "Their AI integration doubled our customer support capacity while cutting response times by 60%. The ROI was evident within weeks.",
    author: "James Park",
  ...
  {
    quote: "Apex Labs rebuilt our entire cloud infrastructure and reduced our AWS bill by 40%. The migration was seamless with zero downtime.",
                ...
                <div className="flex items-center gap-4 pl-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/60">
                      {testimonial.role} at <span style={{ color: testimonial.color }}>{testimonial.company}</span>
                    </p>
                  </div>
                </div>
              </motion.div>
