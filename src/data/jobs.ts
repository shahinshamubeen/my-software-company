...
export const jobs: Job[] = [
  {
    ...
    salary: "$150K - $200K",
    description:
      "Join our core engineering team to build scalable, high-performance applications for our enterprise clients. You'll work on cutting-edge projects spanning AI, fintech, and healthcare.",
    responsibilities: [
  ...
  },
  {
    ...
    salary: "$160K - $220K",
    description:
      "Drive AI innovation by developing and deploying machine learning models that power intelligent features across our client products.",
    responsibilities: [
  ...
  },
  {
    ...
    salary: "$130K - $170K",
    description:
      "Shape the future of digital experiences by creating intuitive, beautiful, and accessible designs for web and mobile applications.",
    responsibilities: [
  ...
  },
  {
    ...
    salary: "$140K - $180K",
    description:
      "Build and maintain robust, scalable infrastructure that powers mission-critical applications for our clients.",
    responsibilities: [
  ...
  },
  {
    ...
    salary: "$120K - $160K",
    description:
      "Lead complex software projects from inception to delivery, ensuring client success through exceptional project management.",
    responsibilities: [
